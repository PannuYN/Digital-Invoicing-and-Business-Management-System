...
<div>
    ...
    <p>Your payment is succeeded. Invoice can be checked below. We will deliver the products within two weeks. Thank you for buying from us."</p>
    <div class="invoice-form flex-column">
        <div class='information'>
            <h1 style="font-weight: bold; margin-top: 20px;">Invoice</h1>
