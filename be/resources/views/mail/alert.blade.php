...
<body>
<div>
  <h1>!!!Payment Overdue Alert!!!</h1>
  <p>Your payment has been over the due date. Please check the order confirmation and pay for it with the payment link we provided below.</p>
    ...
    <a href="http://localhost:3000/wallet/{{$realGrandTotal}}/{{$invoiceId}}">Click Here to pay</a>
</div>
